...
<html lang="en">
	...
	<body>
		...
		<table style="border-collapse: collapse" border="1" >
			<thead style="font-size: 9px">
				<tr>
					...
					<th colspan="10" style="text-align: center">PRUEBAS BÁSICAS</th>
					<th colspan="8" style="text-align: center">PRUEBAS COMPLEMENTARIAS</th>
		...
		<table>
			<tbody>
				<td width="350px" style="font-size: 12px; text-align: center">Cap. Cab. Brian Rolando Fernandez Sejas <br>
					<strong>JEFE DE LA SECCIÓN E.F.M. Y DEPORTES</strong>
				</td>
				<td width="430px" style="font-size: 12px; text-align: center">
					My. DEM. Alex Johnny Carvajal Huchani<br>
					<strong>JEFE DE LA SAM.</strong>
				</td>
				<td width="350px" style="font-size: 12px; text-align: center">Tcnl. DEM. Eddy M. Crespo Velasquez<br>
					<strong>JEFE DE ESTUDIOS DEL COLEGIO MILITAR</strong>
				</td>
			</tbody>
		</table>
		<br><br><br><br>
		<table >
			<tbody>
				<td width="350px"></td>
				<td width="430px" style="font-size: 12px; text-align: center">Cnl. DAEN. Miguel R. Flores Crespo<br>
					<strong>SEGUNDO COMANDANTE DEL COLEGIO MILITAR</strong></td>
				<td width="350px"></td>
			</tbody>
		</table>
		<br><br><br>
		<table>
			<tbody>
				<td width="350px"></td>
				<td width="430px" style="font-size: 12px; text-align: center"><strong>Vo. Bo.</strong></td>
				<td width="350px"></td>
			</tbody>
		</table>
		<br><br><br><br>
		<table>
			<tbody>
				<td width="350px"></td>
				<td width="430px" style="font-size: 12px; text-align: center">Cnl. DAEN. Gregory Olmos Rejas<br>
					<strong>COMANDANTE DEL COLEGIO MILITAR DEL EJÉRCITO</strong></td>
				<td width="350px"></td>
			</tbody>
		</table>
		@endif
        ...
        if ( isset($pdf) ) {
            $pdf->page_script('
                ...
                $pdf->text(445, 580, "$PAGE_NUM - $PAGE_COUNT", $font, 10);
            ');
        }
    	</script>		
	</body>
